...
export const KUSHI_STORES: Store[] = [
  {
    ...
    pick: 4,
    courses: [
      { slot: 'lunch', name: '串揚げ食べ放題（ランチ）', priceInclTax: 2500, minutes: 90, note: '土日祝ランチは2,600・70分の場合あり' },
      { slot: 'dinner', name: '串揚げ食べ放題（ディナー）', priceInclTax: 3600, minutes: 90, note: '土日祝ディナーは3,800の場合あり' },
    ],
    hours: '11:00–22:00',
