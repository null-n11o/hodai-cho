...
2. `docs/superpowers/specs/2026-09-09-reservation-affiliate-design.md`（予約CTAのアフィリエイト。公式は素リンク）
3. `docs/superpowers/plans/2026-09-06-hodai-cho-implementation.md`（実装計画。Task 1〜8実施済み）
4. `docs/PLAN-20260906-300-hodai-cho-expansion.md`、`docs/PLAN-20260906-301-hodai-cho-implementation-plan.md`（原本コピー。履歴参照用）
5. 新規開発の要件・計画は `docs/superpowers/specs/` と `docs/superpowers/plans/` に置く。作り方は「開発フロー」参照。
